...
# OpenAI client (separate from MongoDB client)
openai_client = OpenAI(api_key=os.getenv("OPENAI_API_KEY"))  # Set API key via environment variable


MONGO_URI = "mongodb+srv://teena3:123@cluster0.ojomaf6.mongodb.net/" # connection string 

# Connect to MongoDB (separate from OpenAI client)
...
def ai_insights(prompt: str) -> str:
    """OpenAI API se AI-generated insights generate karta hai"""
    try:
        response = openai_client.chat.completions.create(
            model="gpt-4o-mini",  # Updated model name (gpt-4o-mini or gpt-3.5-turbo)
            messages=[
